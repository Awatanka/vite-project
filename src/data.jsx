export default [
  ...
  {
    id: 6,
    title: "Group Winter Biking",
    description:
      "Experience the beautiful Canadian landscape and meet new friends all while conquering rugged terrain on your bike. (Bike provided!)",
    price: 70,
    coverImg: "cooper.jpg",
    stats: {
      rating: 4.8,
